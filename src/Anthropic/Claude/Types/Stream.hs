...
instance ToJSON ContentBlockStartPayload where
  toJSON (ContentBlockStartPayload idx blk) =
    object
...
instance ToJSON ContentBlockDeltaPayload where
  toJSON (ContentBlockDeltaPayload idx d) =
    object
      ["index" .= idx, "delta" .= d]
...
instance ToJSON MessageDeltaPayload where
  toJSON (MessageDeltaPayload d u) =
    object
      ["delta" .= d, "usage" .= u]
